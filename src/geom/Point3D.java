...
public class Point3D implements Geom_element, Serializable {
	...
	/**
	 * pointLineTest <br>
	 * test the following location of a point regards a line segment - all in 2D
	 * projection.<br>
	 * <br>
	 * 
	 * ONSEGMENT: �����a----+----b������ <br>
	...
	/**
	 * computes the angleXY between p1 and p2 in RADIANS: <br>
	 * <br>
	...
	/**
	 * return the (planer angle of the vector between this --> p, in DEGREES, in
	 * a compass order: north 0, east 90, south 180, west 270.
	 * 
	 * @param p
	 *            is the end point of the vector (z value is ignored).
	 ...
	 * 
	 * @param h
	 *            : is the extra height of the point p (used by GISElement).
	 * */
